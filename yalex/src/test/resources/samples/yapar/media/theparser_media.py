...
ACTION = {
    ...
    2: {"$": ('reduce', 3, "E", 1), "TIMES": ('shift', 8), "RPAREN": ('reduce', 3, "E", 1), "PLUS": ('reduce', 3, "E", 1), "MINUS": ('reduce', 3, "E", 1), "DIVIDE": ('shift', 9)},
    3: {"$": ('reduce', 6, "T", 1), "TIMES": ('reduce', 6, "T", 1), "RPAREN": ('reduce', 6, "T", 1), "PLUS": ('reduce', 6, "T", 1), "MINUS": ('reduce', 6, "T", 1), "DIVIDE": ('reduce', 6, "T", 1)},
    4: {"$": ('reduce', 8, "F", 1), "TIMES": ('reduce', 8, "F", 1), "RPAREN": ('reduce', 8, "F", 1), "PLUS": ('reduce', 8, "F", 1), "MINUS": ('reduce', 8, "F", 1), "DIVIDE": ('reduce', 8, "F", 1)},
    ...
    10: {"RPAREN": ('shift', 15), "PLUS": ('shift', 6), "MINUS": ('shift', 7)},
    11: {"$": ('reduce', 1, "E", 3), "TIMES": ('shift', 8), "RPAREN": ('reduce', 1, "E", 3), "PLUS": ('reduce', 1, "E", 3), "MINUS": ('reduce', 1, "E", 3), "DIVIDE": ('shift', 9)},
    12: {"$": ('reduce', 2, "E", 3), "TIMES": ('shift', 8), "RPAREN": ('reduce', 2, "E", 3), "PLUS": ('reduce', 2, "E", 3), "MINUS": ('reduce', 2, "E", 3), "DIVIDE": ('shift', 9)},
    13: {"$": ('reduce', 4, "T", 3), "TIMES": ('reduce', 4, "T", 3), "RPAREN": ('reduce', 4, "T", 3), "PLUS": ('reduce', 4, "T", 3), "MINUS": ('reduce', 4, "T", 3), "DIVIDE": ('reduce', 4, "T", 3)},
    14: {"$": ('reduce', 5, "T", 3), "TIMES": ('reduce', 5, "T", 3), "RPAREN": ('reduce', 5, "T", 3), "PLUS": ('reduce', 5, "T", 3), "MINUS": ('reduce', 5, "T", 3), "DIVIDE": ('reduce', 5, "T", 3)},
    15: {"$": ('reduce', 7, "F", 3), "TIMES": ('reduce', 7, "F", 3), "RPAREN": ('reduce', 7, "F", 3), "PLUS": ('reduce', 7, "F", 3), "MINUS": ('reduce', 7, "F", 3), "DIVIDE": ('reduce', 7, "F", 3)},
}
